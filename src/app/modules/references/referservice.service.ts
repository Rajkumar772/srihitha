...
export class ReferserviceService {
  ...
  addRefferedBY(data) {
    ...
    return this.http.post<any>(this.Api + `addRefferedBY`, payload).pipe(
      map(
        (res) => {
  ...
  getrefernces() {
    return this.http.post<any>(this.Api + "getRefferedBy", []).pipe(
      map(
        (res) => {
          return res;
        },
  ...
  //////new code starts for hospital counts
  getrefernceshospitalcounts() {
    return this.http.post<any>(this.Api + "getrefhospitalcounts", []).pipe(
      map(
        (res) => {
          return res;
        },
  ...
  getrefernceshospitalselectedcounts(data) {
    return this.http.post<any>(this.Api + "getrefernceshospitalselectedcounts",data).pipe(
      map(
        (res) => {
          return res;
        },
