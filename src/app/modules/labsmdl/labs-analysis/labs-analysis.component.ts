...
@Component({
  selector: 'app-labs-analysis',
  templateUrl: './labs-analysis.component.html',
  styleUrls: ['./labs-analysis.component.scss']
})
export class LabsAnalysisComponent implements OnInit {
  ...
  rjyarray: any = [];
  constructor(public service:LabsServicesService) { }

  ngOnInit(): void {
    this.toatlLabtests();
    this.getmostlabtestse();
    this.getweekLabdata();
    this.getdailydata();
    this.vsgraph1();
  }
  ...
  toatlLabtests() {
    this.service.toatlLabtests().subscribe((res: any) => {
  ...
  getweekLabdata() {
    ...
    this.service.getweekLabdata().subscribe(res => {
  ...
  getmostlabtestse() {
    this.showSpinner = true
    this.service.getmostlabtests().subscribe((res: any) => {
      ...
      var myChart = new Chart(ctx, {
        type: 'doughnut',
        data: {
          labels: ["Total Tests", "Most Frequent Lab Test", "Test Count"],
          datasets: [{
            backgroundColor: [
              "#42d1f5",
              "#FFB6C1",
            ...
            data: [this.userarray[0].total_tests, this.userarray[0].	
            most_frequent_labtest_name, this.userarray[0].most_frequent_labtest_count],
            borderWidth: [0, 0, 0]
          }]
        },
        options: {
  ...
  getdailydata() {
    this.showSpinner = true
    this.service.getdailydata().subscribe(res => {
      this.showSpinner = false
  ...
  vsgraph1() {
    this.showSpinner = true
    this.service.getmonthlydata().subscribe((res: any) => {
      this.showSpinner = false
