...
export class DigilockerService {
  ...
  digilocker = environment.texturespaceURL; private alertShown: boolean = false;
  ...
  getSearchForMRDreports(data) {
    return this.http.post<any>(this.digilocker + `getSearchForMRDreports`, data).pipe(map((res) => {
  ...
  uploadoriginaldocumentsdigipost(data: any) {
    return this.http.post<any>(this.digilocker + `uploadoriginaldocumentsdigipost`, data).pipe(map(res => {
      return res;
    }));
  }
   getdigilockerreport(data:any) {
    return this.http.post<any>(this.digilocker + `getdigilockerreport/`,data).pipe(map(res => {
      return this.handleResponse(res);
    }, error => {
      this.errorAlert();
      return error;
