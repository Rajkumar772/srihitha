...
@Component({
  selector: 'app-inventorypurchadse',
  templateUrl: './inventorypurchadse.component.html',
  styleUrls: ['./inventorypurchadse.component.scss']
})
export class InventorypurchadseComponent implements OnInit {
  ...
  submitroomtype() {
    ...
    this.service.add_assettypepostdatapurchasestore(data).subscribe(
      (res: any) => {
        this.showSpinner = false;
  ...
  getroomtypedata() {
    this.showSpinner = true;
    this.service.getassettypepurchasestore().subscribe(
      (res: any) => {
        this.showSpinner = false;
  ...
  selectequipment(event: any) {
    ...
    this.service.getequipmentwisecompanypurchasestore(data).subscribe(res => {
      this.showSpinner = false;
  ...
  selectcompanynamewisemodel(event: any) {
    ...
    this.service.getcompanywisemodelstorepurchase(data).subscribe(res => {
      this.showSpinner = false;
  ...
  selectmodelname(event: any) {
    ...
    this.service.getmodelpatchdatastorepurchase(data).subscribe((res: any) => {
  ...
  //   this.service.getdepartmentdropdownstorepurchase().subscribe(res => {
  //     this.showSpinner = false;
